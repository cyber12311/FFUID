# decoder by cobra linux command __Tools Owner AKASH Afridy
# https://github.com/AKASH-AFRIDY/DECODER
...
\033[0;96m
 ...
 > \033[0;92mDEVELOPER     : AKASH EVAN
 > \033[0;95mFACEBOOK ID   : AKASH EVAN AKASH
 > \033[0;41mWHATSAPP      : FUKE YOU🖕
 \033[0;96m> YOUTUBE       : AKASH WORLD
 > \033[0;97mWARNING       : DONT USE FOR ILLEGAL WORK     
    """)
		...
		print("")
		print("%s [%s1%s]%s CRACK RANDOM FREE FIRE ID 50,60 LEVEL IDZ%s(FREE)"%(C,S,E,D,A,B))
		print("%s [%s2%s]%s CRACK RANDOM FF ID LOW LEVEL %s(PRO) V1"%(G,R,G,Y,G))
		print("%s [%s3%s]%s CRACK RANDOM FF ID MIDUME LEVEL %s(PRO) V2"%(G,R,G,Y,G))
		print("%s [%s4%s]%s CRACK RANDOM FF ID HIG LEVEL %s(PRO) V3"%(G,R,G,Y,G))
		print("%s [%s5%s]%s CRACK FROM EMAILS %s(PRO)"%(G,R,G,Y,G))
		print("%s [%s6%s]%s CRACK RANDOM FF ID Custom %s(PRO) V1"%(G,R,G,Y,G))
		print(GET)
		hoga = input("\n%s [?] CHOICE : "%(B))
		if hoga in ["", " "]:
			Main()
